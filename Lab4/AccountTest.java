...
public class AccountTest
{
   ...
   public static void main( String args[] ) 
   {
      ...
      double withdrawAmount; // withdrawal amount read from user
      ...
      System.out.printf( "\nsubtracting %.2f from account1 balance\n\n", 
         withdrawAmount );
      account1.debit( withdrawAmount ); // subtract from account2 balance
      ...
      System.out.printf( "\nsubtracting %.2f from account2 balance\n\n", 
         withdrawAmount );
      account2.debit( withdrawAmount ); // subtract from account2 balance
